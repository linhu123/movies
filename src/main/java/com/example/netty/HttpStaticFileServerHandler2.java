...
public class HttpStaticFileServerHandler2 extends SimpleChannelInboundHandler<HttpRequest> {
	...
	public void channelRead0(ChannelHandlerContext ctx, HttpRequest request) throws Exception {
		...
		response.headers().add(HttpHeaders.Names.ACCESS_CONTROL_ALLOW_HEADERS,"Origin,X-Requested-With,Content-Type, Accept");
		response.headers().add(HttpHeaders.Names.ACCESS_CONTROL_ALLOW_METHODS,"GET,POST,PUT,DELETE");
